...
class datapacker_v2 {
    ...
    /**
     * @param shipData {Array} [45910, 641, 10, 10, 0, 34, 24, 25, 13, 10, 14, 14]
     *   0-id
     *   1-masterId
     *   2-lvl
     *   3-sally
     ...
     *   10-lk
     *   11-hp
     *   format should be in ShipParser
     * @returns {string} packed string like "27sb890aa0y0o0p0d0a0e0e"
     */
    _packShip(shipData) {
        let str, s;
        ...
        /**
         ...
         ~39 symbols for ship id... should be enough for this century
         */
        str = this._encode(shipData[4] * 39 + packedId.length - 1);
        ...
        /**
         * sally up to 79. 1 char
         */
        str += this._encode(shipData[3]);
    ...
    /**
     *
     * @param str {string} like "27sb890aa0y0o0p0d0a0e0e"
     * @returns {Array} like this [45910, 641, 10, 10, 0, 34, 24, 25, 13, 10, 14, 14]
     */
    _unpackShip(str) {
        let shipData = [];
        let arr = str.split(""), s = "";
